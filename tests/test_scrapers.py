...
from scrapers import fetch_balance, fetch_summary_report, parse_summary_page
...
class TestScrapers:
    def test_fetch_balance_success(self) -> None:
        ...
        name, balance, credit, error = fetch_balance(session, "18", 10)
        assert name == "TestCo"
    ...
    def test_fetch_summary_success(self) -> None:
        ...
        results, error = fetch_summary_report(session, s)
    ...
    def test_parse_summary_with_thead(self) -> None:
    ...
    def test_parse_summary_no_thead(self) -> None:
